...
export const translations = {
  ...
  hero: {
    ...
    subtitle:
      "Reserva con los Principales Especialistas en Salud de la Mujer - A Tu Ritmo.",
    ...
    items: [
      {
        ...
        image:
          "/img/Pregnant-Woman-Flowers.jpg?height=450&width=300?monochrome=006D77",
        cta: "Leer más",
      },
      {
  ...
  mission: {
    ...
    subtitle:
      "Transformar la salud femenina a través de la innovación y la compasión",
    description:
