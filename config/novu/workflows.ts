    ...
    await step.email('expert-welcome-email', async () => ({
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px;">
          ...
          <h3>Ahora puedes:</h3>
          <ul>
            <li>Recibir reservas de clientes</li><li>Gestionar tu disponibilidad</li><li>Seguir tus ganancias</li><li>Construir tu base de clientes</li>
          </ul>
          <div style="text-align: center; margin: 30px 0;">
            <a href="{{payload.dashboardUrl}}" style="background-color: #006D77; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block;">
              Ir al Panel
...
type AnyWorkflowPayload = WorkflowPayloads[keyof WorkflowPayloads];
type NovuWorkflow = Workflow<AnyWorkflowPayload>;

// Export all workflows grouped by locale
export const workflowsByLocale: Record<SupportedLocale, NovuWorkflow[]> = {
  en: [
    welcomeWorkflowEN,
