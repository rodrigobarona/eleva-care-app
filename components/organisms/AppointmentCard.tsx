...
export function AppointmentCard({
  ...
  // Calculate time until expiration for reservations - use useState with lazy initialization to avoid impure function during render
  const [timeUntilExpiration] = useState(() => {
