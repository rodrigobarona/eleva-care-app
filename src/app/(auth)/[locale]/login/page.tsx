 ...
 * - Error handling
 */
export default async function SignInPage({ params: paramsPromise, searchParams }: SignInPageProps) {
  const params = await searchParams;
  await paramsPromise; // Consume params promise (locale not needed as we redirect to WorkOS)
