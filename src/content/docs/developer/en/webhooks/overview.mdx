...
<Steps>
  <Step>
    ...
    An event occurs in Eleva Care (e.g., booking confirmed).

  </Step>
  <Step>
    ### HTTP POST Sent

    Eleva Care sends an HTTP POST to your webhook URL.
...
<Accordions>
  ...
  <Accordion title="Verify Timestamps">
...
<Tabs items={['Dashboard', 'API', 'Local Development']}>
  <Tab value="Dashboard">
