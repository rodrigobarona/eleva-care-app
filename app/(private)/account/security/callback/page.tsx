        ...
        if (handleRedirectCallback && typeof handleRedirectCallback === 'function') {
          ...
          if (user) {
            ...
            if (googleAccount) {
              ...
              try {
                // Update the user's metadata directly to ensure google_account is set to true
                if (user?.unsafeMetadata) {
                  // Get current expertSetup or initialize if not exists
                  const expertSetup = {
                    ...((user.unsafeMetadata.expertSetup as Record<string, boolean>) || {}),
                  };

                  // Set Google account to true explicitly
                  ...
                  setDebugInfo('Directly updated metadata to set google_account=true');
                }
