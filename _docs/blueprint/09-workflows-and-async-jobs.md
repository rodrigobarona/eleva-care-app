...
export const bookingConfirmation = workflow<Input>(
  'booking-confirmation',
  async ({ step, sleep, input }) => {
...
```ts
export const multibancoReminders = workflow<{ paymentIntentId: string }>(
