...
Late Multibanco payments (after 7 days): If the slot is no longer available or violates practitioner rules, we automatically refund 90% and retain a 10% processing fee.
