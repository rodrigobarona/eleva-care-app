...
<div className="mt-16 rounded-3xl bg-gradient-to-br from-pink-50 to-purple-50 py-12 text-center">
  <h3 className="mb-4 text-2xl font-semibold text-gray-900">Ready for evidence-based care?</h3>
  <div className="mx-auto mb-8 max-w-xl text-gray-600">
    Join thousands of women who have found specialists at Eleva Care who truly understand them.
  </div>
  <Button
    size="lg"
