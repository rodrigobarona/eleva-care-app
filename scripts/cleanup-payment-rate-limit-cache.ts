#!/usr/bin/env tsx
/**
 * Payment Rate Limit Cache Cleanup Script
 *
 * This script cleans up corrupted payment rate limit cache entries
...
// Validate Redis environment before starting
...
async function cleanupPaymentRateLimitCache(): Promise<CleanupStats> {
...
async function main() {
  try {
    console.log('🚀 Starting payment rate limit cache cleanup...');
...
export { cleanupPaymentRateLimitCache };
