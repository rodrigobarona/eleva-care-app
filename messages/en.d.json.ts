...
declare const messages: {
  ...
  "metadata": {
    ...
    "description": "Eleva Care: Empowering growth, embracing care. Expert care for pregnancy, postpartum, menopause, and sexual health.",
    "og": {
      "title": "Expert care for Pregnancy, Postpartum & Sexual Health | Eleva Care",
      "description": "Eleva Care: Empowering growth, embracing care. Expert care for pregnancy, postpartum, menopause, and sexual health.",
      "siteName": "Eleva Care"
  ...
  "About": {
    ...
    "description": "Eleva Care provides expert care for pregnancy, postpartum, menopause, and sexual health."
  },
  "Legal": {
  ...
  "services": {
    ...
    "description": "Access personalized care from top-rated women's health professionals worldwide. We connect you with the expertise you need, from online consultations to local resources, all tailored to your unique health journey.",
    "items": [
      {
        "icon": "Baby",
        "title": "Pregnancy & Postpartum",
        "description": "Comprehensive care to support women through the transformative journey of pregnancy and early motherhood.",
        "items": [
      ...
      },
      {
        "icon": "Droplets",
        "title": "Pelvic Health",
        "description": "Specialized care addressing the unique pelvic health needs of women throughout their lives.",
        "items": [
      ...
      },
      {
        ...
        "description": "Holistic support for women's health concerns from adolescence through menopause and beyond.",
        "items": [
      ...
      },
      {
        ...
        "description": "Specialized support for women facing breast and gynecological cancers, providing comprehensive care from diagnosis through survivorship.",
        "items": [
  ...
  "team": {
    ...
    "description": "Eleva Care is led by a team of dedicated professionals who bring together years of experience in women's health, technology, and patient care. Our founders and key team members are committed to revolutionizing the way women access and experience healthcare.",
    "members": [
      {
        "name": "Patricia Mota, PT, PhD",
        "role": "Co-Founder & CEO",
        "image": "/img/team/team-patricia-mota-2.jpeg?height=1200&width=1200",
        "quote": "Our mission is to elevate women's healthcare by making it more accessible, innovative, and empowering for all women."
      },
      {
        ...
        "quote": "Clinical research and education empower women to make informed decisions about their healthcare journey."
      },
      {
        ...
        "quote": "Evidence-based physical therapy transforms the pregnancy and birth experience, empowering women through every stage."
      },
      {
        "name": "Patricia Driusso, PT, PhD",
        "role": "Board Advisor (Women's Health)",
        "image": "/img/team/team-patricia-driusso.jpg?height=1200&width=1200",
        "quote": "Clinical research advances rehabilitation treatments while empowering women through evidence-based education."
      },
      {
        "name": "Annelie Gutke, PT, PhD",
        "role": "Board Advisor (Women's Health)",
        "image": "/img/team/team-annelie-gutke.jpg?height=1200&width=1200",
        "quote": "Understanding pain mechanisms transforms how we care for women during pregnancy and beyond."
      },
      {
        "name": "Ruben Barakat, PhD",
        "role": "Board Advisor (Exercise Science)",
        "image": "/img/team/team-ruben-barakat.jpg?height=1200&width=1200",
        "quote": "Evidence shows that personalized exercise during pregnancy can transform women's health outcomes."
      },
      {
        "name": "Jessica Margarido, PT",
        "role": "Oncology Rehabilitation",
        "image": "/img/team/team-jessica-margarido.jpg?height=1200&width=1200",
        "quote": "Evidence-based rehabilitation restores function and quality of life throughout cancer care."
      },
      {
        "name": "Joana Goulão Barros, MD, PhD",
        "role": "Obstetrics & Gynecology",
        "image": "/img/team/team-joana-barros.jpg?height=1200&width=1200",
        "quote": "Integrating medical expertise with specialized rehabilitation creates the highest standard of prenatal care."
      },
      {
        "name": "Rodrigo Barona",
        "role": "Co-Founder",
        "image": "/img/team/team-rodrigo-barona.jpg?height=1200&width=1200",
        "quote": "We are transforming women's healthcare by combining clinical expertise with innovative technology."
      }
    ]
  },
  "newsletter": {
    ...
    "description": "Your monthly spotlight on women's health insights, expert advice, and empowering stories to nurture every stage of your wellness journey.",
  ...
  "footer": {
    "cta": {
      ...
      "heading": "Discover Your Personalized Care Journey Today",
      "description": "Take our quick health assessment or schedule your consultation.",
      "quiz": "Take the Quiz",
      "book": "Book a Session"
    },
    "tagline": "Empowering women's health through expert care and innovation.",
    "nav": {
      "services": {
        "title": "Services",
  ...
  "experts": {
    ...
    "description": "Connect with top-rated experts in physiotherapy, and women's health. Our platform offers access to leading professionals ready to support your unique health and wellness journey.",
    "topExpertBadge": "Top Expert",
    "sessionLabel": "Session",
    "expertImageAlt": "Profile photo of {name}",
    "verifiedBadgeAlt": "Verified Expert Badge"
  }
};
