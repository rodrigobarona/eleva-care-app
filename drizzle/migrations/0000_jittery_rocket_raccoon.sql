CREATE TYPE "public"."pack_purchase_status" AS ENUM('active', 'fully_redeemed', 'expired', 'cancelled');--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "meetings" (
	...
	"calendar_creation_claimed" boolean DEFAULT false NOT NULL,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE IF NOT EXISTS "session_packs" (
	...
	"expiration_days" integer DEFAULT 180,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "pack_purchases" ADD CONSTRAINT "pack_purchases_pack_id_session_packs_id_fk" FOREIGN KEY ("pack_id") REFERENCES "public"."session_packs"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "session_packs" ADD CONSTRAINT "session_packs_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "pack_purchases_pack_id_idx" ON "pack_purchases" USING btree ("pack_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pack_purchases_buyer_email_idx" ON "pack_purchases" USING btree ("buyer_email");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pack_purchases_promotion_code_idx" ON "pack_purchases" USING btree ("promotion_code");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pack_purchases_stripe_session_id_idx" ON "pack_purchases" USING btree ("stripe_session_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "session_packs_clerk_user_id_idx" ON "session_packs" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "session_packs_event_id_idx" ON "session_packs" USING btree ("event_id");--> statement-breakpoint
