...
const browserCollections = {
  ...
  trust: create.doc("trust", {"dpa/en.mdx": () => import("../src/content/trust/dpa/en.mdx?collection=trust"), "dpa/es.mdx": () => import("../src/content/trust/dpa/es.mdx?collection=trust"), "dpa/pt-BR.mdx": () => import("../src/content/trust/dpa/pt-BR.mdx?collection=trust"), "dpa/pt.mdx": () => import("../src/content/trust/dpa/pt.mdx?collection=trust"), "security/en.mdx": () => import("../src/content/trust/security/en.mdx?collection=trust"), "security/es.mdx": () => import("../src/content/trust/security/es.mdx?collection=trust"), "security/pt-BR.mdx": () => import("../src/content/trust/security/pt-BR.mdx?collection=trust"), "security/pt.mdx": () => import("../src/content/trust/security/pt.mdx?collection=trust"), }),
};
