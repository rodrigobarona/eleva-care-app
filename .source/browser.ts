...
const browserCollections = {
  ...
  expertDocs: create.doc("expertDocs", {"en/index.mdx": () => import("../src/content/docs/expert/en/index.mdx?collection=expertDocs"), "en/getting-started/availability.mdx": () => import("../src/content/docs/expert/en/getting-started/availability.mdx?collection=expertDocs"), "en/getting-started/profile.mdx": () => import("../src/content/docs/expert/en/getting-started/profile.mdx?collection=expertDocs"), "en/getting-started/services.mdx": () => import("../src/content/docs/expert/en/getting-started/services.mdx?collection=expertDocs"), "en/earnings/payouts.mdx": () => import("../src/content/docs/expert/en/earnings/payouts.mdx?collection=expertDocs"), "en/earnings/pricing.mdx": () => import("../src/content/docs/expert/en/earnings/pricing.mdx?collection=expertDocs"), "en/top-expert/benefits.mdx": () => import("../src/content/docs/expert/en/top-expert/benefits.mdx?collection=expertDocs"), "en/top-expert/requirements.mdx": () => import("../src/content/docs/expert/en/top-expert/requirements.mdx?collection=expertDocs"), }),
