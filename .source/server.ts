...
import * as __fd_glob_11 from "../src/content/docs/expert/en/earnings/pricing.mdx?collection=expertDocs"
import * as __fd_glob_10 from "../src/content/docs/expert/en/earnings/payouts.mdx?collection=expertDocs"
import * as __fd_glob_9 from "../src/content/docs/expert/en/getting-started/services.mdx?collection=expertDocs"
import * as __fd_glob_8 from "../src/content/docs/expert/en/getting-started/profile.mdx?collection=expertDocs"
import * as __fd_glob_7 from "../src/content/docs/expert/en/getting-started/availability.mdx?collection=expertDocs"
...
export const expertDocs = await create.doc("expertDocs", "src/content/docs/expert", {"en/index.mdx": __fd_glob_6, "en/getting-started/availability.mdx": __fd_glob_7, "en/getting-started/profile.mdx": __fd_glob_8, "en/getting-started/services.mdx": __fd_glob_9, "en/earnings/payouts.mdx": __fd_glob_10, "en/earnings/pricing.mdx": __fd_glob_11, "en/top-expert/benefits.mdx": __fd_glob_12, "en/top-expert/requirements.mdx": __fd_glob_13, });
