...
import * as __fd_glob_10 from "../src/content/docs/expert/en/top-expert/requirements.mdx?collection=expertDocs"
import * as __fd_glob_9 from "../src/content/docs/expert/en/top-expert/benefits.mdx?collection=expertDocs"
...
export const expertDocs = await create.doc("expertDocs", "src/content/docs/expert", {"en/index.mdx": __fd_glob_6, "en/earnings/payouts.mdx": __fd_glob_7, "en/earnings/pricing.mdx": __fd_glob_8, "en/top-expert/benefits.mdx": __fd_glob_9, "en/top-expert/requirements.mdx": __fd_glob_10, "en/getting-started/availability.mdx": __fd_glob_11, "en/getting-started/profile.mdx": __fd_glob_12, "en/getting-started/services.mdx": __fd_glob_13, });
