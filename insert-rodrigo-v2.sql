...
-- Fixed version with proper result handling
...
-- Step 3: Insert user and membership
DO $$
DECLARE
...
BEGIN
  ...
  RAISE NOTICE 'Organization ID: %', org_internal_id;
END $$;

COMMIT;

-- Step 4: Verify the setup (runs AFTER commit)
SELECT
  u.workos_user_id,
  u.email,
